...
<div class="padding">
  <div class="box">
	...
	<span style="float: left;"><h2>Transfers</h2></span> 
    <span style="float: right;">
         <a href="<?php echo $baseurl; ?>/add/transfer" ><button class="btn btn-outline btn-sm rounded b-primary text-primary"><i class="fa fa-plus"></i> Add New</a></button>&nbsp;

<?php 
if (isset($_GET['view'])) 
{ 
?>
<a href="<?php echo $baseurl; ?>/transfers" ><button class="btn btn-outline btn-sm rounded b-success text-success"><i class="fa fa-list"></i> View Recent</a></button>
<?php 
}
else 
{ 
?>
<a href="<?php echo $baseurl; ?>/transfers?view=all" ><button class="btn btn-outline btn-sm rounded b-success text-success"><i class="fa fa-list"></i> View All</a></button>
<?php 
} ?>
</span>
    </div><br/>
...
<!--          <form role="form" action="<?php echo $baseurl;?>/items" method="post">
    ...
    <div>
      ...
      <table class="table m-b-none" data-ui-jp="footable" data-filter="#filter" data-page-size="<?php echo $list_count;?>">        <thead>
		...
		{
		$sql = "SELECT * FROM transfers ORDER BY id DESC LIMIT 0,100";
                }
