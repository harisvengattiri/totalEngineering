...
{
    $sql3 = "UPDATE invoice SET `transport`='0',`grand`=`grand`-'$transport' WHERE id='$invoice'";
    $query3 = mysqli_query($conn,$sql3);
    
    $sql4 = "UPDATE invoice SET `transport`='$trp_charge',`grand`=`grand`+ '$trp_charge' WHERE id='$invoice'";
