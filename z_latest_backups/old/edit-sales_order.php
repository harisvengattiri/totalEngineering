...
"window.location='sales_order?id=$prj&status=failed2';". 
"</script>";
...
if ($conn->query($sql) === TRUE) {
    ...
    for($i=0;$i<$count;$i++)
    {
    $sql2="INSERT INTO order_item (item_id,o_r,item,comment,quantity,unit,total) VALUES ('$prj','$order_refrence','$item[$i]','$comment[$i]','$quantity[$i]','$unit[$i]','$total[$i]')";
    $conn->query($sql2);
    }
    ...
    $conn->query($sql_flag);
      ...
      echo  "<script type=\"text/javascript\">".
            "window.location='sales_order?id=$prj&status=failed';". 
            "</script>";
}

}
echo "<script type=\"text/javascript\">".
"window.location='sales_order?id=$prj';". 
"</script>";
}}
	...
	<p><a class="list-group-item b-l-danger">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <form role="form" action="<?php echo $baseurl;?>/edit/sales_order?id=<?php echo $prj;?>" method="post" enctype="multipart/form-data">
               ...
               ?>
					...
					<tr>
						...
						<td style="width:15%;" class="text-right">
							<div class="form-group form-group-sm no-margin-bottom">
								<input type="number" min="1" step="any" class="form-control invoice_product_qty calculate" name="invoice_product_qty[]" value="<?php echo $quantity;?>">
							</div>
						</td>
						<td style="width:15%;" class="text-right">
							<div class="input-group input-group-sm  no-margin-bottom">
								<!--<span class="input-group-addon"><?php echo CURRENCY ?></span>-->
                                                             <input type="number" min="1" step="any" class="form-control calculate invoice_product_price required" name="invoice_product_price[]" value="<?php echo $unit;?>" aria-describedby="sizing-addon1" placeholder="0.00">
							</div>
						</td>
<!--						<td class="text-right">
							<div class="form-group form-group-sm  no-margin-bottom">
			...
			<input type="hidden" name="invoice_subtotal" id="invoice_subtotal">
                    ...
                    <div class="col-sm-8">
                         <input style="width:95%;" class="form-control" type="number" step=".01" value="<?php echo $transport;?>" name="transport">
                    </div>
                    </div>
            ...
            <div class="form-group row m-t-md">
              <div align="right" class="col-sm-offset-2 col-sm-12">
                <a href="<?php echo $baseurl;?>/sales_order" class="btn btn-sm btn-outline rounded b-danger text-danger">Cancel</a>
