...
<div class="padding">
  <div class="box">
    <div class="box-header">
        ...
        ?>
	<span style="float: left;"><h2>Cash Flow Statement [<?php echo $staffname;?>]</h2></span> 
    </div><br/>
    <div class="box-body">
...
UNION ALL (SELECT CONCAT('WRI', id) AS id, CONCAT(wtype,work) AS purchaser, collector, paid, duedate, notes FROM work_invoices WHERE (paid>0 AND collector='$staff' AND method='cash'))
