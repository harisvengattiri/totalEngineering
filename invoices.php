        ...
        ?>
            <div class="box-header">
                ...
                <span style="float: right;">
                    <a href="<?php echo BASEURL; ?>/add/invoice"><button class="btn btn-outline btn-sm rounded b-primary text-primary"><i class="fa fa-plus"></i> Add New Invoice</a></button>
                    &nbsp;
                </span>
            </div><br />
            <div class="box-body">

                <form role="form" action="<?php echo BASEURL; ?>/invoices" method="POST">
            ...
            <div>
                <table class="table m-b-none" data-ui-jp="footable" data-filter="#filter" data-page-size="10">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    <td>INV|<?php echo sprintf("%06d", $invoiceId); ?></td>
                                    <td><?php echo $customer; ?></td>
                                    <td><?php echo $row["date"]; ?></td>
                                    <td>No</td>
                                    <td><?php echo custom_money_format('%!i', $row["grand"]); ?></td>
                                    <td>
                                        <a target="_blank" href="<?php echo CDNURL; ?>/invoice?id=<?php echo $invoiceId;?>"><button class="btn btn-xs btn-icon success"><i class="fa fa-folder-open"></i></button></a>
                                        <!-- <a href="<?php // echo BASEURL; ?>/edit/invoice?id=<?php // echo $row["id"]; ?>"><button class="btn btn-xs btn-icon info">
                                            <i class="fa fa-pencil"></i></button></a> -->
                                        <a href="<?php echo BASEURL; ?>/controller?controller=invoice&submit_delete_invoice=delete&id=<?php echo $invoiceId;?>" onclick="return confirm('Are you sure?')"><button class="btn btn-xs btn-icon danger"><i class="fa fa-trash"></i></button></a>
                                    </td>
                                </tr>
                        <?php } } ?>
                    </tbody>
