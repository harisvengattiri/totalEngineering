            ...
            icons: {
              ...
              close: 'fa fa-remove'
               ...
               <div align="right" class="col-sm-offset-2 col-sm-12">
                ...
                <button type="submit" formaction="<?php echo $cdn_url;?>/reports/vat_rpt" class="btn btn-sm btn-outline rounded b-success text-success">Print</button>
              </div>
              </div>
          </form>
        </div>
