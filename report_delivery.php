...
<div class="padding">
    ...
    <div class="box-body bot-mar-buttons">
    <style>
            .bot-mar-buttons button{margin-bottom: 5px;}
    </style> 
     ...
     <button id="godaily" type="button" class="btn btn-success">Daily Delivery Report</button>
    </div></div></div></div>

  <div style="display: none;" id="daily" class="row">
    <div class="col-md-6">
      <div class="box">
        <div class="box-header">
        ...
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/report/daily_delivery" method="post" onsubmit="target_popup(this)">
            ...
            <div class="form-group row m-t-md">
              <div align="right" class="col-sm-offset-2 col-sm-12">
                ...
                <button type="submit" formaction="<?php echo $cdn_url;?>/reports/daily_delivery" class="btn btn-sm btn-outline rounded b-info text-info">Print</button>
              </div>
            </div>
          </form>
        </div>
   ...
   <div style="display: none;" id="del" class="row">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/report/delivery" method="post" onsubmit="target_popup(this)">
            ...
            icons: {
              ...
              <label for="date" align="right" class="col-sm-1 form-control-label">To</label>
              <div class="col-sm-5">
                <input type="text" name="tdate" required id="tdate" placeholder="End Date" class="form-control has-value" data-ui-jp="datetimepicker" data-ui-options="{
            format: 'DD/MM/YYYY',
            icons: {
              time: 'fa fa-clock-o',
              date: 'fa fa-calendar',
    ...
    <div class="col-md-8">
      <div class="box">
        ...
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/report/analytic_new" method="post" onsubmit="target_popup(this)">
