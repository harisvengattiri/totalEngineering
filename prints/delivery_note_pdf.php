...
<td align="right" style="width: 15%;">Plot Number:</td>
...
<th style="width: 12%;">COC No. (BBCE)</th>
<th style="width: 7%;">Bndl.</th>
<th style="width: 8%;">Qty (<?php echo $actualunit;?>)</th>
</tr>

<?php
             $sql="SELECT * FROM delivery_item where delivery_id = '$dno' AND batch != '' AND thisquantity != ''";
             $query=mysqli_query($conn,$sql);
             $qn1 = 0;
             $sl = 0;
             $totalqty = 0;
          ...
          <tr>
            ...
            <?php } else { ?>
            <td align="left"><?php echo $item1;?>-<?php echo $comment;?></td>
            <?php } ?>
            ...
            <td align="center"><?php echo $coc;?></td>
