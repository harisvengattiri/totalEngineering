        ...
        ?>
            <div class="box-header">
                ...
                <span style="float: right;">
                    <a href="<?php echo BASEURL; ?>/add/delivery_note"><button class="btn btn-outline btn-sm rounded b-primary text-primary"><i class="fa fa-plus"></i> Add New Delivery Note</a></button>
                    &nbsp;
                </span>
            </div><br />
            <div class="box-body">
