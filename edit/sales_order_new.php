          ...
          <div class="box-body">
            ...
            <form role="form" action="<?php echo $baseurl; ?>/edit/sales_order_new?id=<?php echo $prj; ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" name="lpo_date" value="<?php echo $lpo_date; ?>" id="lpo_date" placeholder="Date" class="form-control has-value" data-ui-jp="datetimepicker" data-ui-options="{
                      format: 'DD/MM/YYYY',
                      icons: {
                        time: 'fa fa-clock-o',
                        date: 'fa fa-calendar',
                      ...
                      <tr class="product-list">
                        ...
                        <td style="width:15%;" class="text-right">
                          <div class="form-group">
                            <input type="number" min="1" step="any" class="form-control" name="invoice_product_qty[]" value="<?php echo $quantity; ?>" readonly>
                          </div>
                        </td>
                        <td style="width:15%;" class="text-right">
                          <div class="form-group">
                            <input type="number" min="1" step="any" class="form-control" name="invoice_product_price[]" value="<?php echo $unit; ?>" readonly>
                          </div>
                        </td>

                        <td style="width:15%;" class="text-right">
                          <div class="form-group">
                            <input type="text" class="form-control" name="invoice_product_sub[]" id="invoice_product_sub" value="<?php echo $total; ?>" readonly>
                          </div>
                        </td>
              ...
              <div class="row">
                <div style="float:right;">
                  ...
                  <div class="row" style="padding: 5px 0;">
                      ...
                      <div class="col-sm-8">
                        <input style="width:95%;" class="form-control" type="text" value="<?php echo $sub_total;?>" name="invoice_subtotal" id="invoice_subtotal" readonly>
                      </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-8">
                      <input style="width:95%;" class="form-control" type="number" step=".01" name="transport" id="transport" value="<?php echo $transport; ?>" readonly>
                    </div>
                  </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-8">
                        <input style="width:95%;" class="form-control" type="text" name="invoice_total" id="invoice_total" value="<?php echo $grand_total;?>" readonly>
                      </div>
                  </div>
