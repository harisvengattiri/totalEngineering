...
$notes=$_POST["notes"];
$cst=$_POST["cst"];
$sql = "UPDATE `credit_settlements` SET `fromid` = '$fromid', `toid` = '$toid', `date` =  '$date', `amount` =  '$amount', `notes` =  '$notes' WHERE  `id` = $cst";
...
$cst=$_GET["cst"];
	...
	$sql = "SELECT * FROM credit_settlements where id=$cst";
        $result = mysqli_query($conn, $sql);
	...
	<?php }?>
      <div class="box">
        <div class="box-header">
          <h2>Edit Credit Settlement</h2>
          </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/edit/credit_settlement" method="post">

<div class="form-group row">
               <input name="cst"  type="text" value="<?php echo $cst;?>" hidden="hidden">
