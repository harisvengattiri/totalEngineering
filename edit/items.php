...
$sql = "UPDATE items SET items = '$items',price = '$price', weight = '$weight', description = '$description', dimension = '$dimension', bundle = '$bundle',"
        . " unit = '$unit',sqm= '$sqm' WHERE id='$prj'";
  ...
  <div class="row">
	...
	<?php }?>
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/edit/items?id=<?php echo $prj;?>" method="post">
