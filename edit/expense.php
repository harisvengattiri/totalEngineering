...
$sql = "UPDATE `expenses` SET `particulars`='$particulars', `category`='$category', `subcategory`='$subcategory', `purchaser`='$purchaser', `shop`='$shop',
     `date`='$date',`inv`='$inv',`amt`='$amt',`vat`='$vat', `amount`='$amount', `method`='$method', `notes`='$notes' WHERE id='$id'";
  ...
  <div class="row">
	...
	<?php }?>
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/edit/expense?exp=<?php echo $id;?>" method="post">
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-4">
                   ...
                   <input type="hidden" name="exp" value="<?php echo $id;?>">
              </div>
          </div>
...
<div class="col-sm-4">
    <select name="category" id="categoriesSelect" placeholder="category" class="form-control select2" data-ui-jp="select2" data-ui-options="{theme: 'bootstrap'}">
         <option value="<?php echo $category1;?>" selected><?php echo $category;?></option>
...
<div class="col-sm-4">
    <select name="subcategory" id="subcatsSelect" placeholder="SubCategory" class="form-control select2">
         <option value="<?php echo $subcategory1;?>"><?php echo $subcategory;?></option>
    </select>
</div>
</body>
</div>
    ...
    <!--          </div>-->
              ...
              <div class="col-sm-4"> 
				...
				<option value="<?php echo $shop1;?>"><?php echo $shop;?></option>
				<?php 
