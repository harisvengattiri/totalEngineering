        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                if ($_REQUEST) {
                    ...
                    $period_sql = "WHERE STR_TO_DATE(so.`date`, '%d/%m/%Y') BETWEEN STR_TO_DATE('$fdate', '%d/%m/%Y') AND STR_TO_DATE('$tdate', '%d/%m/%Y')";

                    $customer = $_REQUEST['customer'];
                    if (!empty($customer)) {
                        $cust_sql = "AND so.`customer`='$customer'";
                    } else {
                        $cust_sql = "";
                    }
                ...
                <table class="table m-b-none" data-ui-jp="footable" data-filter="#filter" data-page-size="<?php echo $list_count; ?>">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['view'])) {
                            ...
                            $period_sql $cust_sql
                            ORDER BY so.id DESC LIMIT 0,1000
                            ";
                        } else {
                            ...
                            ORDER BY so.id DESC LIMIT 0,200
                            ";
                        }
