 ...
 <div style="" id="batch" class="row">
    <div class="col-md-6">
      <div class="box">
		...
		<select name="rep" class="form-control">
               ...
               <div align="right" class="col-sm-offset-2 col-sm-12">
                ...
                <button name="print" type="submit" formaction="<?php echo $cdn_url;?>/reports/convert_percentage" class="btn btn-sm btn-outline rounded b-success text-success">Print</button>
              </div>
              </div>
          </form>
        </div>
     ...
     <div class="col-md-12">
      <div class="box">
        <div class="box-header">
             <h2>Comparison & Percentage From : <?php echo $fdate;?> - <?php echo $tdate;?></h2>
          </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
