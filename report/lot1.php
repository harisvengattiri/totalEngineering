...
$lot=$_POST["lot"];
               ...
               $sqlitem="SELECT item from batches_lots where batch='$lot'";
...
<h2><?php echo strtoupper($status);?> LOT REPORT OF <?php echo $lot;?> [Item: <?phpecho $item1;?>]</h2>
...
//	$sql = "SELECT * FROM sales_order where date BETWEEN '$fdate' AND '$tdate'";
        ...
        if (mysqli_num_rows($result1) > 0) 
	{
        ...
        <tr><td></td><td></td><td></td><td></td><td></td><td> <?php echo $total;?></td><td></td><td></td> </tr>       
      </table>
<?php
