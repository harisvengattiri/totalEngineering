...
<?php
  ...
  while($row = $result->fetch_assoc()){
    $subcats[$row['parent']][] = array("id" => $row['category'], "val" => $row['category']);
  }
...
$sql = "INSERT INTO `works` (`wname`, `work`, `wtype`, `division`, `staff`, `date`, `notes`) 
VALUES ('$wname',  '$work', '$wtype', '$division', '$staff',  '$date', '$notes')";
	...
	<?php }?>
      <div class="box">
        <div class="box-header">
          <h2>Add New Daily Work</h2>
          </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">

          <form name="addwork" role="form" action="<?php echo $baseurl;?>/add/work" method="post">



<div class="form-group row">

             <label for="wname" class="col-sm-2 form-control-label">Work Name</label>
              <div class="col-sm-4">
               <input type="text" class="form-control" name="wname" id="wname" placeholder="Name / Short Description">
              </div>
...
<div class="col-sm-4">
    ...
    <option selected value=""> Select the Work First </option>
            ...
            <div class="form-group row">
              <label for="staff" class="col-sm-2 form-control-label">Staff</label>
              <div class="col-sm-4">
