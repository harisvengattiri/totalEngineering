...
<div class="padding">
    ...
    <div class="col-md-6">
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/accounts/ledger" method="post" onsubmit="target_popup(this)">
            ...
            <div class="form-group row m-t-md">
              <div align="right" class="col-sm-offset-2 col-sm-12">
                ...
                <button type="submit" formaction="<?php echo $baseurl;?>/accounts/ledger_print" class="btn btn-sm btn-outline rounded b-primary text-primary">Print</button>
  ...
  <div id="sitepo" class="row">
    <div class="col-md-6">
      <div class="box">
        <div class="box-header">
             <h2>Trial Balance New
                  <!--<span style="color:red;">[From & To Dates are mandatory]</span>-->
             </h2>
          </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/accounts/ledgerNew" method="post" onsubmit="target_popup(this)">
