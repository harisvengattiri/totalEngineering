...
<?php 
    ...
    <div>
      ...
      <thead>
		...
		if (isset($_GET['view']))
		{
		$sql = "SELECT * FROM petty_cash_new ORDER BY id DESC LIMIT 0,100";
        }
        else
		{
		$sql = "SELECT * FROM petty_cash_new ORDER BY id DESC LIMIT 0,300";
        }
        ...
        ?>
          <tr>
              ...
              <a href="<?php echo $baseurl; ?>/edit/petty_cash_new?id=<?php echo $row["id"];?>"><button class="btn btn-xs btn-icon info"><i class="fa fa-pencil"></i></button></a>
