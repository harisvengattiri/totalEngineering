...
<div class="padding">
    ...
    <div class="col-md-6">
      <div class="box">
        ...
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/report/order_site_po" method="post" onsubmit="target_popup(this)">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/report/sales_order" method="post" onsubmit="target_popup(this)">
            ...
            icons: {
              ...
              <div class="col-sm-4">
                <input type="text" name="tdate" id="tdate" Required="Required" placeholder="End Date" class="form-control has-value" data-ui-jp="datetimepicker" data-ui-options="{
            format: 'DD/MM/YYYY',
            icons: {
              time: 'fa fa-clock-o',
              date: 'fa fa-calendar',
          ...
          <div class="form-group row">
              <div class="col-sm-6">
               <select name="company" id="customer2" class="form-control">
				<?php 
				$sql = "SELECT name,id FROM customers where type='Company' order by name";
				$result = mysqli_query($conn, $sql);
				if (mysqli_num_rows($result) > 0) 
              ...
              <div class="col-sm-6">
                   <select name="site" id="site2" class="form-control">
                        <option value="">SITE</option>
                   </select>
              </div>
            </div>
            ...
            <div class="form-group row">   
            <div class="col-sm-6">
                   <select name="po" id="po2" class="form-control">
                        <option value="">LPO</option>
                   </select>
            </div>
          ...
          <div class="form-group row">    
            ...
            <div class="form-group row m-t-md">
              <div align="right" class="col-sm-offset-2 col-sm-12">
                ...
                <!--<button name="print" type="submit" class="btn btn-sm btn-outline rounded b-info text-info">Print</button>-->
                <button name="submit" type="submit" class="btn btn-sm btn-outline rounded b-success text-success">View</button>
                <button type="submit" formaction="<?php echo $cdn_url;?>/reports/convert_report_order" class="btn btn-sm btn-outline rounded b-success text-success">Print</button>
              </div>
            </div>
          </form>
        </div>
