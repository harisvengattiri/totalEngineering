...
<div class="padding">
  <div class="box col-md-6">
    ...
    <div class="box-body">
         ...
         <form role="form" action="<?php echo $baseurl;?>/balance_statement" method="post">
    ...
    <tr>
      <td><b>ASSETS</b></td>
           ...
           <?php
            ...
            $enbd = ($enbd_cr+$enbd_cr1)-($enbd_dr+$enbd_dr1);
            $amount_asset1[] = $enbd;
          ?>
          <?php
            $sql = "SELECT * FROM (
            ...
            $cbd = ($cbd_cr+$cbd_cr1)-($cbd_dr+$cbd_dr1);
            $amount_asset1[] = $cbd;
          ?>
             <tr>
              <td>BANK - E.N.B.D</td>
    ...
    <!--row ends here-->
            <tr>
                  ...
                  <?php
                   $amount_asset2 = ($amount_asset2 != NULL) ? $amount_asset2 : [0];
                   $amount_asset2_total = number_format(array_sum($amount_asset2), 2, '.', '');?>
    ...
    <!--row ends here-->
        <tr>
           <td><b>Total Long-Term Liabilities</b></td>
            <?php
            $amount_lbl2 = ($amount_lbl2 != NULL) ? $amount_lbl2 : [0];
            $amount_lbl2_total = number_format(array_sum($amount_lbl2), 2, '.', '');?>
