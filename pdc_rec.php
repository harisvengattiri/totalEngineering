...
<div class="padding">
  <div class="box col-md-6">
	...
	<span style="float: left;"><h2>Check Receivable PDC Details</h2></span>
    </div><br/>
    <div class="box-body">
         
         <form role="form" action="<?php echo $baseurl;?>/report/pdc_details_rec" method="post" onsubmit="target_popup(this)">
