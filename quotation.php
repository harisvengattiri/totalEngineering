        ...
        ?>
            <div class="box-header">
                ...
                <span style="float: right;">
                    <a href="<?php echo BASEURL; ?>/add/quotation"><button class="btn btn-outline btn-sm rounded b-primary text-primary"><i class="fa fa-plus"></i> Add New Quotation</a></button>
                    &nbsp;
                </span>
            </div><br />
            <div class="box-body">
                ...
                <table class="table m-b-none" data-ui-jp="footable" data-filter="#filter" data-page-size="10">
                    ...
                    <tbody>
                        ...
                        if (isset($_POST['fdate'])) {
                            ...
                            $sql = "SELECT * FROM quotation ORDER BY id DESC LIMIT 0,100";
                        }
                        $result = mysqli_query($conn, $sql);
                        if (mysqli_num_rows($result) > 0) {
