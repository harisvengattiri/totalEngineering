...
$price=$_POST['price'];
$sqm=$_POST['sqm'];
$sql = "INSERT INTO `items` (`items`,`price`,`description`,`dimension`,`bundle`,`unit`,`sqm`) 
VALUES ('$items','$price','$description','$dimension','$bundle','$unit','$sqm')";
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
               ...
               <div class="form-group row">
	              ...
	              <div class="col-sm-4">
	                <input type="hidden" class="form-control" name="sqm" value="1" placeholder="SQM Value">
	              </div>
               </div>
