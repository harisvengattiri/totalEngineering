...
$method=$_POST["method"];
$notes=$_POST["notes"];
$sql = "INSERT INTO `vehicle_expenses` (`vehicle`, `purpose`, `purchaser`, `shop`, `date`, `amount`, `method`, `notes`) 
VALUES ('$vehicle', '$purpose', '$purchaser', '$shop', '$date', '$amount', '$method', '$notes')";
	...
	<?php }?>
      <div class="box">
        <div class="box-header">
          <h2>Add New Vehicle Expense</h2>
          </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/vehicle_expense" method="post">
            <div class="form-group row">
              <label for="number" class="col-sm-2 form-control-label" >Vehicle Number</label>
              <div class="col-sm-4">
                <select name="number" id="number" placeholder="Number" class="form-control select2" data-ui-jp="select2" data-ui-options="{theme: 'bootstrap'}">
				<?php 
              ...
              <label for="purpose" align="right" class="col-sm-2 form-control-label">Category</label>
              <div class="col-sm-4">
                <select name="purpose" id="purpose" placeholder="Expense Category" class="form-control">
...
<div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                <input type="number" step="0.01" class="form-control" name="amount" id="amount"  placeholder="Expense Amount">
              </div>
