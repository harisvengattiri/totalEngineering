...
$sql = "INSERT INTO `sales_order` (`token`, `customer`, `site`, `salesrep`, `date`, `lpo`, `lpo_date`, `lpo_pdf`, `order_referance`, `sub_total`, `vat`, `grand_total`, `transport`) 
  ...
  <div class="row">
	...
	<p><a class="list-group-item b-l-danger">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/new_sales_order" method="post" enctype="multipart/form-data">
						...
						<td style="width:30%;">
							<div class="form-group form-group-sm  no-margin-bottom">
								...
								<!--<input type="text" class="form-control form-group-sm item-input invoice_product" name="invoice_product[]" placeholder="Enter item title and / or description">-->
                                                ...
                                                <td style="width:20%;">
							<div class="form-group form-group-sm  no-margin-bottom">
                                                             <input type="text" class="form-control invoice_product_qty calculate" name="comment[]">
							</div>
						</td>
...
<!--						<td class="text-right">
			...
			<input type="hidden" name="invoice_subtotal" id="invoice_subtotal">
                   ...
                   <div class="row">
                    ...
                    <div class="col-sm-8">
                         <input style="width:95%;" class="form-control" type="number" step=".01" name="transport">
                    </div>
                    </div> 
