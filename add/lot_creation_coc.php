...
VALUES ('$item','$batch', '$date', '$pdate', '$COCNo', '$quantity', '$batch_type', '1')";
  ...
  <div class="row">
    ...
    <?php } ?>
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/lot_creation_coc" method="post">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
				...
				?>
				<option value="<?php echo $row["item"]; ?>"><?php echo $fetchitem['items'];?></option>
				<?php 
				}} 
				?>
                </select>
              ...
              <div class="form-group row">
              <label for="type" align="left" class="col-sm-4 form-control-label">Available Production Qty</label>
              <div class="col-sm-8" id="state">
                   <input type="text" class="form-control" name="avl" readonly>
              </div>
            ...
            <div class="form-group row">
             <label for="Quantity" class="col-sm-4 form-control-label">Batch No</label>
               <div class="col-sm-8">
                   <?php 
                   $sql = "SELECT batch FROM batches_lots WHERE batch_type='COC' ORDER BY id DESC LIMIT 1";
				$result = mysqli_query($conn, $sql);
				if (mysqli_num_rows($result) > 0) 
				{
                    $value=0;
				...
				{ 
                    $value=$row["batch"]+1;
				?>
                   <input type="" class="form-control" name="batch" value="<?php echo $value;?>" <?php if($_SESSION['role'] != 'admin') { ?> readonly <?php } ?>>
				<?php 
				}}
		  ?>
