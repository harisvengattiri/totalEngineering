...
if ($conn->query($sql) === TRUE) {
    ...
    $sql1 = "INSERT INTO `order_item` (`item_id`,`o_r`,`item`, `quantity`, `balance`, `unit`, `total`) 
VALUES ('$last_id','$order_refrence','$item[$i]', '$quantity[$i]', '$quantity[$i]', '$unit[$i]', '$total[$i]')";
     $conn->query($sql1);
    }
  ...
  <div class="row">
	...
	<p><a class="list-group-item b-l-danger">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/old_sales_order1" method="post">
               <div class="form-group row">
               <label class="col-sm-2 form-control-label">Sales Order Ref</label>
               <div class="col-sm-6">
                   <input type="text" class="form-control" name="order_refrence" placeholder="Sales Order Ref">
               </div>     
               </div>
            <div class="form-group row">
   ...
   //                                  $value=$row["order_referance"]+1;
		  ...
		  ?>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                   <input type="number" min="0" step="any" class="form-control" name="quantity[]" id="input1" placeholder="Quantity">
              </div>
              <div class="col-sm-2">
                <input type="number" min="0" step="any" class="form-control" name="unit[]" id="input2" placeholder="Unit Price">
              </div>
              <div class="col-sm-2">
