...
if ($conn->query($sql) === TRUE) {
    ...
    for($i=0;$i<$count;$i++)
    {
     ...
     VALUES ('$last_id', '$date', '$staff', '$exp[$i]', '$sub[$i]', '$des[$i]', '$amount[$i]', '$vat[$i]', '$total[$i]')";
     $conn->query($sql1); 
    }
	...
	<?php }?>
      <div class="box">
        <div class="box-header">
          <h2>Add New Petty Cash Flow</h2>
        </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/petty_cash" method="post">
              <div class="form-group row">
                    <script>
                      ...
                      $('#staff').change(function() {
                         ...
                         if(country_id != "") {
                           $.ajax({
                             url:"my_scripts/getbalance_voucher",
              ...
              <div class="col-sm-2">
                   <input type="number" id="balance" min="0.01" step="any" class="form-control" value="0" name="balance" placeholder="Amount" readonly>
              </div>
              <div class="col-sm-4">
             <?php
              $today = date('d/m/Y');
