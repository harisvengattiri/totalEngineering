...
$sql = "INSERT INTO `sales_order` (`customer`, `site`, `salesrep`, `date`, `lpo`, `lpo_date`, `order_referance`, `sub_total`, `vat`, `grand_total`) 
VALUES ('$customer', '$site', '$salesrep', '$date', '$lpo', '$lpo_date', '$order_refrence', '$sub', '$vat', '$grand')";
