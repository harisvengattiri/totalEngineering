...
VALUES ('$customer', '$date', '$invoice', '1', '40', '175', '$amount', '$vat', '$total', '$time')";
  ...
  <div class="row">
	...
	<p><a class="list-group-item b-l-danger">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/crdt_note_qnt" method="post">
            ...
            <div class="form-group row">
               ...
               <label align="center" class="col-sm-2 form-control-label"><b>Return</b></label>
...
//            $sql1="SELECT * FROM invoice_item WHERE invoice_id='$invoice'";
           ...
           <div class="form-group row">
              ...
              <div class="col-sm-2">
                   <input type="text" class="form-control" name="return[]" id="box1<?php echo $id;?>" oninput="calculate<?php echo $id;?>()" placeholder="Return">
              </div>
              <div class="col-sm-2">
                   <input type="text" class="form-control" name="price[]" value="<?php echo $unit;?>" id="box2<?php echo $id;?>" placeholder="Price" readonly>
              </div>
              <div class="col-sm-2">
