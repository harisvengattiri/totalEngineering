  ...
  <div class="row">
    ...
    <?php } ?>
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/lot_creation_non-coc" method="post">
            ...
            <div class="form-group row">
             <label for="Quantity" class="col-sm-4 form-control-label">Batch No</label>
               <div class="col-sm-8">
                   <?php 
                   $sql = "SELECT batch FROM batches_lots WHERE batch_type='Non COC' ORDER BY id DESC LIMIT 1";
				$result = mysqli_query($conn, $sql);
				if (mysqli_num_rows($result) > 0) 
				{
                    $value=0;
