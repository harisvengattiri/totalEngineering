...
for($i=0;$i<$n;$i++)
{
  if($r[$i]>=$b[$i])
     ...
     if($taken==$required){echo 'SUCCESS';}else{echo 'FAIL';}
  ...
  <div class="row">
	...
	<?php } else if($status=="failed1") {?>
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/test_delivery_note" method="post">
                                             ...
                                             while($row1=$result1->fetch_assoc()) 
                                                     {
                                                        ...
                                                        $sql2="SELECT * FROM delivery_item WHERE batch='".$batch."'"; 
                                                        $result2=$conn->query($sql2);
                                                        $quantity2=0;
                                                        while($row2=$result2->fetch_assoc()) 
                                                        {
                                                        $quantity2=$quantity2+$row2['thisquantity'];     
                                                        }
                                                        $sql3="SELECT * FROM stock_return WHERE batch='".$batch."'"; 
                                                        $result3=$conn->query($sql3);
                                                        $quantity4=0;
                                                        while($row3=$result3->fetch_assoc()) 
                                                        {
                                                        $quantity4=$quantity4+$row3['returnqnt'];
                                                        }
                                                        $quantity3=$quantity1+$quantity4-$quantity2;
                                                        if($quantity3>0){
                             ?>
