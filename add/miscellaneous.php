...
$sql = "INSERT INTO `miscellaneous` (`date`, `clearance_date`, `status`, `particulars`, `method`, `customer`, `bank`, `amount`, `vat`,`total`) 
	...
	<?php }?>
      <div class="box">
        <div class="box-header">
          <h2>Add New Miscellaneous Income</h2>
        </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/miscellaneous" method="post">
             
            <div class="form-group row">
              <label for="particulars" class="col-sm-2 form-control-label">Particulars</label>
              <div class="col-sm-4">
                <input type="particulars" class="form-control" name="particulars" id="particulars" placeholder="Particulars">
              </div>
           ...
           <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="number" step="0.01" class="form-control" name="amt" id="input1"  placeholder="Amount" required >
              </div>
