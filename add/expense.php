...
<div class="col-sm-4">
    ...
    <!--           <select name="purchaser" id="purchaser" placeholder="Purchaser" class="form-control select2" data-ui-jp="select2" data-ui-options="{theme: 'bootstrap'}">-->
				...
				<?php 
				// $sql = "SELECT id,name FROM customers where type='Company' ORDER BY name ASC";
				// $result = mysqli_query($conn, $sql);
    ...
    <!--          </div>-->
              ...
              <div class="col-sm-4"> 
              <select name="shop" id="shop" placeholder="supplier" required class="form-control select2" data-ui-jp="select2" data-ui-options="{theme: 'bootstrap'}">
				<option value=""></option>
				<?php 
