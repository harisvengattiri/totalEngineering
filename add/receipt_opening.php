...
$sql = "INSERT INTO `reciept` (`customer`, `site`, `amount`, `discount`, `grand`, `pmethod`, `type`, `pdate`, `gldate`, `duedate`, `clearance_date`, `post_dated`, `ref`, `cheque_no`, `bank`, `cat`, `inward`,`rep`,`status`,`time`) 
VALUES ('$customer', '$site', '$tamount', '0.00', '$tamount', '$pmethod', '1',  '$pdate', '$gldate', '$duedate', '$clearancedate', '$postdated', '$ref', '$checkno', '$bank', '36', '$inward', '$rep', '$status1', '$time')";
	...
	<p><a class="list-group-item b-l-danger">
      ...
      <div class="box">
        <div class="box-header">
          <h2>Generate New Opening Receipt</h2>
          </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/receipt_opening" method="post">
