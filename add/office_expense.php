...
$method=$_POST["method"];
$notes=$_POST["notes"];
$sql = "INSERT INTO `office_expenses` (`particulars`, `category`, `purchaser`, `shop`, `date`, `amount`, `method`, `notes`) 
VALUES ('$particulars', '$category', '$purchaser', '$shop', '$date', '$amount', '$method', '$notes')";
	...
	<?php }?>
      <div class="box">
        <div class="box-header">
          <h2>Add New Office Expense</h2>
          </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/office_expense" method="post">
