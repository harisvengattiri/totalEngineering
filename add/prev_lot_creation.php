        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/lot_creation" method="post">
            <div class="form-group row">
              ...
              <label for="type" align="right" class="col-sm-2 form-control-label">Available Quantity</label>
              <div class="col-sm-4" id="state">
               ...
               <div class="form-group row">
                   <label for="date" class="col-sm-2 form-control-label">Date of Lot Creation</label>
              ...
              <div class="col-sm-2">
               ...
               close: 'fa fa-remove'
                    ...
                    <label for="date" class="col-sm-2 form-control-label">Production Date</label>
              <div class="col-sm-2">
               ...
               close: 'fa fa-remove'
                ...
                <label for="Quantity" class="col-sm-2 form-control-label">Quantity for Lot</label>
              <div class="col-sm-2">
		  ...
		  ?>
              ...
              <label for="Quantity" align="right" class="col-sm-2 form-control-label">Batch Type</label>
              <div class="col-sm-2">
