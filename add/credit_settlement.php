...
$amount=$_POST["amount"];
$notes=$_POST["notes"];
$sql = "INSERT INTO `credit_settlements` (`fromid`, `toid`, `date`, `amount`, `notes`) 
	...
	<?php }?>
      <div class="box">
        <div class="box-header">
          <h2>Add New Credit Settlement</h2>
          </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/credit_settlement" method="post">
