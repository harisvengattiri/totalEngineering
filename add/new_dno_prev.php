...
<div class="padding">
  <div class="row">
	...
	<?php } else if($status=="failed1") {?>
      ...
      <div class="box">
        ...
        ?> <option value="<?php echo $customer;?>"><?php echo $cust;?></option> <?php
              ...
              <div class="form-group row">
              <label for="startd" align="" class="col-sm-2 form-control-label">Customer Site</label>
              <div class="col-sm-4">
            ...
            <div class="form-group row m-t-md">
             ...
             ?>
              ...
              $date = date('d/m/y');
              ?>
              <label for="date" align="" class="col-sm-2 form-control-label">Current Date</label>
              <div class="col-sm-4">
    ...
    <form role="form" action="<?php echo $baseurl;?>/add/new_dno" method="post">
              ...
              <div class="form-group row">
              <label for="startd" class="col-sm-1 form-control-label">LPO</label>
              <div class="col-sm-2" id="veh">
            ...
            icons: {
              ...
              <div class="form-group row">
              <label align="" for="startd" class="col-sm-1 form-control-label">Vehicle</label>
              <div class="col-sm-2" id="veh">
             ...
             <label for="endd" align="right" class="col-sm-1 form-control-label">Driver</label>
              <div class="col-sm-2" id="nam">
        ...
        ?><option value="<?php echo ''; ?>"><?php echo '';?></option><?php
            ...
            <div class="form-group row">
            <label for="date" align="" class="col-sm-1 form-control-label">Note</label>
            <div class="col-sm-5">
            ...
            <div class="form-group row">  
                 ...
                 <label align="" class="col-sm-2 form-control-label" style="color:red;">Transportation [If Needed]</label>
...
<div class="box-body">  -->
      ...
      <div class="form-group row">
          <div class="col-sm-2">
            ...
            <select class="form-control" name="item[]" id="delItem_0">
                <?php                                
                      $sql1="SELECT oi.item AS itemId,itm.items AS itemName FROM `order_item` oi INNER JOIN `items` itm ON oi.item=itm.id
                              WHERE oi.item_id=$id";
                      ...
                      {
                      ?>
                        <option value="<?php echo $row1['itemId'];?>"> <?php echo $row1['itemName'];?> </option>
                      <?php  } } ?>                    
            </select>
          </div>
  ...
  <script>
        $(document).ready(function() {
          ...
          $('#sub').click(function() {
           var a = $('#this_0').val();
           var b = $('#quantityReq_0').val();
           var c = $('#lotStock_0').val();
           ...
           var currentGoodsWeight = parseFloat($("#currentWeight").val());
             ...
             if (parseInt(a) > parseInt(b) || (parseInt(a) > parseInt(c))) {
              alert('Delivery is more than available stock in the batch or required order of row 1');
              return false;
             }
            ...
            $('#divAttach').append(deliveryRow);
                      ...
                      $(deliveryRow).on('change', '[id^="delItem_"]', function() {
                        var deliveryItemRow = this.id.split('_')[1];
                          ...
                          $('#sub').on('click', () => validateDeliveryInput(deliveryItemRow));
