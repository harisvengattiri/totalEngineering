...
VALUES ('$id1','$order_referance','$rep','$customer', '$customersite', '$lpo', '$date', '$vehicle', '$driver', '$note', '$transport')";
...
//       $conn->query($sql3);
       ...
       $sql1 = "INSERT INTO `delivery_item` (`delivery_id`,`order_referance`, `item`, `date`, `reqquantity`, `thisquantity`, `price`,`amt`, `bundle`,`pdate`,`coc`,`batch`) 
VALUES ('$id1','$order_referance', '$item[$i]', '$date', '$reqquantity[$i]', '$thisquantity[$i]', '$price[$i]', '$amt[$i]', '$bundle[$i]', '$pdate', '$coc[$i]', '$batch[$i]')";
$conn->query($sql1);
       }
