...
$amount=$_POST["amount"];
$notes=$_POST["notes"];
$sql = "INSERT INTO `liabilities` (`id`, `name`, `category`, `subcategory`, `date`, `amount`, `notes`) 
...
<div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="particulars" class="form-control" name="particulars" id="particulars" placeholder="Liability Name">
              </div>
              </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="text" name="date" id="date" placeholder="Occurance Date" class="form-control has-value" data-ui-jp="datetimepicker" data-ui-options="{
            format: 'DD/MM/YYYY',
            icons: {
              time: 'fa fa-clock-o',
              date: 'fa fa-calendar',
