	...
	<?php }?>
      <div class="box">
        ...
        <div class="box-body">
          ...
          <form role="form" action="<?php echo $baseurl;?>/add/quotation_neww" method="post">
           ...
           <!--</div>-->
            ...
            <div class="form-group row col-md-6" style="margin-bottom:3px;">
               ...
               <div class="col-sm-3">
                ...
                <select name="item[]" id="item0" class="form-control" placeholder="Item" required>
...
$('#btnAddMoreSpecification').click(function () {
    ...
    var row='<div class="form-group row" style="margin-bottom:3px;">\n\
                <label for="name" align="right" class="col-sm-1 form-control-label">Item</label>\n\
                <div class="col-sm-3">\n\
     ...
     if(uid<=9)
     {
     $('#divSpecificatiion1').append(row);
     }
     if(uid>9 && uid<=19)
     {
     $('#divSpecificatiion2').append(row);
     }
