...
$sql = "INSERT INTO `expenses` (`id`, `particulars`, `category`, `subcategory`, `purchaser`, `shop`, `date`,`inv`,`amt`,`vat`, `amount`, `method`, `notes`) 
VALUES ('NULL', '$particulars', '$category', '$subcategory', '$purchaser', '$shop', '$date', '$inv', '$amt', '$vat', '$amount', '$method', '$notes')";
  ...
  <div class="row">
	...
	<?php }?>
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/expense" method="post">

          <div class="form-group row">
              <label for="particulars" class="col-sm-2 form-control-label">Invoice No</label>
              <div class="col-sm-4">
                <input class="form-control" name="inv" placeholder="Invoice No">
              </div>
          </div>
...
<div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="number" step="0.01" class="form-control" name="amt" id="input1"  placeholder="Expense Amount">
              </div>
              <label for="amount" align="right" class="col-sm-2 form-control-label">VAT</label>
              <div class="col-sm-4">
                <input type="number" step="0.01" class="form-control" name="vat" id="input2" value='100' placeholder="VAT Amount">
              </div>
            </div>
