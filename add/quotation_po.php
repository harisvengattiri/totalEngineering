...
$sql = "INSERT INTO `qtn_test` (`customer`, `site`, `salesrep`, `date`,`attention`,`terms`,`status`) 
VALUES ('$customer', '$site', '$salesrep', '$date','$attention','$terms','$status')";
  ...
  <div class="row">
	...
	<?php }?>
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/quotation_po" method="post">
