...
//       echo "<option value='" . $row['site'] . "'>" . $row['site'] . "</option>";
    ...
    <form role="form" action="<?php echo $baseurl;?>/add/old_delivery_note" method="post">
              ...
              <div class="col-sm-8" id="veh">
                   <input type="text" class="form-control" value="<?php echo $id1;?>" name="id1">
              ...
              <div class="form-group row">
              <label align="" for="startd" class="col-sm-4 form-control-label">Vehicle</label>
              <div class="col-sm-8" id="veh">
            ...
            <div class="form-group row">
            <label for="date" align="" class="col-sm-4 form-control-label">Note</label>
            <div class="col-sm-8">
...
<?php
       ...
       ?> 
               ...
               <?php
				...
				while($row = mysqli_fetch_assoc($result)) 
				{
                                     ...
                                     $sqlret="SELECT returnqnt from stock_return where order_referance='$or' and item=$item";
       ...
       <div class="form-group row">        
       <label for="endd" class="col-sm-3 form-control-label">LOT Stock Available</label>
       <div class="col-sm-2">
       <input type="text" class="form-control" name="quantity[]" id="quantity<?php echo $id;?>" value="<?php echo $quantity;?>" readonly>
              ...
              <label for="endd"  class="col-sm-1 form-control-label">Quantity</label>
               <div class="col-sm-2">
                    <input type="number" min="0" class="form-control" name="thisquantity[]" placeholder="Quantity From this Batch" id="endd">
              </div>
