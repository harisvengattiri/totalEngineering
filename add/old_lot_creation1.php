  ...
  <div class="row">
    ...
    <?php } ?>
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/old_lot_creation" method="post">
             ...
             <label for="Quantity" class="col-sm-4 form-control-label">Batch No</label>
               <div class="col-sm-8">
				...
				{ 
                                     $value=$row["batch"]+1;
				?>
                   <input type="" class="form-control" name="batch" value="<?php echo $value;?>">
				<?php 
				}}
                                else{
                                     $value=18850000;
                                    ?> <input type="" class="form-control" name="batch" value="<?php echo $value;?>"><?php
                                    }
		  ?>
