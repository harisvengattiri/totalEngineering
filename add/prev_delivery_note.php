...
VALUES ('$last_id','$order_referance', '$item[$i]', '$date', '$reqquantity[$i]', '$thisquantity[$i]', '$price[$i]', '$bundle[$i]', '$pdate[$i]', '$coc[$i]', '$batch[$i]')";
$conn->query($sql1);
...
//       echo "<option value='" . $row['site'] . "'>" . $row['site'] . "</option>";
    ...
    <form role="form" action="<?php echo $baseurl;?>/add/delivery_note" method="post">
              ...
              <div class="form-group row">
              <label align="left" for="startd" class="col-sm-2 form-control-label">Vehicle</label>
              <div class="col-sm-4" id="veh">
            ...
            <div class="form-group row">
            <label for="date" align="left" class="col-sm-2 form-control-label">Note</label>
            <div class="col-sm-4">
