 ...
 <div style="" id="batch" class="row">
    <div class="col-md-8">
      <div class="box">
        ...
        <div class="box-body">
                   <form role="form" action="<?php echo $baseurl;?>/ledger" method="post">
...
<!-- row starts here--> 
          ...
          ?>
          <?php
          $sql = "SELECT sum(amount) AS credit FROM reciept WHERE inward='1291' AND status='Cleared'";
          $query = mysqli_query($conn,$sql);
...
<!-- row starts here-->
        ...
        if (mysqli_num_rows($result1) > 0)
	{
       ...
       <?php } } ?>
             ...
             <tr>
              <td>BANK - CREDIT</td>
              <td align="right"><?php echo custom_money_format('%!i', $credit);?></td>
              <td align="right"></td>
             </tr>
