...
// $html = file_get_contents('https://mancon.gulfit.in/prints/invoice_tax_split_pdf?inv='.$inv.'&open='.$open);
// include("../includes/mpdf/mpdf.php");
// $mpdf=new mPDF('utf-8', 'Letter', 0, '', 10, 10, 0, 50, 0, 0);

$html = file_get_contents($baseurl.'/prints/invoice_tax_split_pdf?inv='.$inv.'&open='.$open);
