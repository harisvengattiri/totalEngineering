...
// $html = file_get_contents('http://mancon.gulfit.in/mpdf/report_percentage-pdf?fd='.$fdate.'&td='.$tdate.'&rep='.$rep);
// include("../includes/mpdf/mpdf.php");
// $mpdf=new mPDF('utf-8', 'A4', 0, '', 10, 10, 30, 0, 0, 0);
$html = file_get_contents($baseurl.'/mpdf/report_percentage-pdf?fd='.$fdate.'&td='.$tdate.'&rep='.$rep);
...
$mpdf->WriteHTML($html);
$mpdf->Output('Percentage Statement #.pdf', 'I');
exit;
?>