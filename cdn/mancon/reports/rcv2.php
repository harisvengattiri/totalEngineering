...
// $html = file_get_contents('http://mancon.gulfit.in/mpdf/rcv2_pdf?company='.$customer);
// include("../includes/mpdf/mpdf.php");
// $mpdf=new mPDF('utf-8', 'A4', 0, '', 10, 10, 30, 0, 0, 0);
$html = file_get_contents($baseurl.'/mpdf/rcv2_pdf?company='.$customer);
...
$mpdf->WriteHTML($html);
$mpdf->Output('Receivable ll Report.pdf.pdf', 'I');
exit;
?>