...
// $html = file_get_contents('http://mancon.gulfit.in/mpdf/report_veh-pdf?fd='.$fdate.'&td='.$tdate.'&vehicle='.$vehicle);
// include("../includes/mpdf/mpdf.php");
// $mpdf=new mPDF('utf-8', 'A4', 0, '', 10, 10, 30, 0, 0, 0);
$html = file_get_contents($baseurl.'/mpdf/report_veh-pdf?fd='.$fdate.'&td='.$tdate.'&vehicle='.$vehicle);
...
$mpdf->WriteHTML($html);
$mpdf->Output('Vehicle Report.pdf', 'I');
exit;
?>