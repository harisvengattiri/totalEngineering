...
// $html = file_get_contents('http://mancon.gulfit.in/mpdf/report_comparison-pdf?date='.$today.'&rep='.$rep);
// include("../includes/mpdf/mpdf.php");
// $mpdf=new mPDF('utf-8', 'A4', 0, '', 10, 10, 30, 0, 0, 0);
$html = file_get_contents($baseurl.'/mpdf/report_comparison-pdf?date='.$today.'&rep='.$rep);
...
$mpdf->WriteHTML($html);
$mpdf->Output('Comparison Report.pdf', 'I');
exit;
?>