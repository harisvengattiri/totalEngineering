...
// $html = file_get_contents('http://mancon.gulfit.in/mpdf/pay_rpt_pdf?customer='.$customer.'&view='.$view);
// include("../includes/mpdf/mpdf.php");
// $mpdf=new mPDF('utf-8', 'A4', 0, '', 10, 10, 30, 0, 0, 0);
$html = file_get_contents($baseurl.'/mpdf/pay_rpt_pdf?customer='.$customer.'&view='.$view);
...
$mpdf->WriteHTML($html);
$mpdf->Output('Payable Report.pdf', 'I');
exit;
?>