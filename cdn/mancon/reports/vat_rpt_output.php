...
// $html = file_get_contents('http://mancon.gulfit.in/mpdf/vat_rpt_output_pdf?fd='.$fdate.'&td='.$tdate);
// include("../includes/mpdf/mpdf.php");
// $mpdf=new mPDF('utf-8', 'A4', 0, '', 10, 10, 30, 0, 0, 0);
$html = file_get_contents($baseurl.'/mpdf/vat_rpt_output_pdf?fd='.$fdate.'&td='.$tdate);
...
$mpdf->WriteHTML($html);
$mpdf->Output('Output VAT Report.pdf', 'I');
exit;
?>