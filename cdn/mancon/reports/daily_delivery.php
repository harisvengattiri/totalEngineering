...
// $html = file_get_contents('http://mancon.gulfit.in/mpdf/daily_delivery-pdf?fd='.$fdate.'&td='.$tdate);
// include("../includes/mpdf/mpdf.php");
// $mpdf=new mPDF('utf-8', 'A4', 0, '', 10, 10, 30, 0, 0, 0);
$html = file_get_contents($baseurl.'/mpdf/daily_delivery-pdf?fd='.$fdate.'&td='.$tdate);
...
$mpdf->WriteHTML($html);
$mpdf->Output('Daily Delivery Report.pdf', 'I');
exit;
?>