      ...
      <div data-flex class="hide-scroll">
          <nav class="scroll nav-stacked nav-stacked-rounded nav-color">
            ...
            <ul class="nav" data-ui-nav>
              ...
              <li>
                <a href="<?php echo $baseurl; ?>/" class="b-success">
              ...
              <li>
                <a href="<?php echo $baseurl; ?>/customers" class="b-danger">
                  <span class="nav-icon text-white no-fade">
              ...
              <li>
                ...
                <ul class="nav-sub">
                  <li>
                    <a href="<?php echo $baseurl; ?>/work_reports" >
                      <span class="nav-text">Work Reports</span>
                    </a>
                  </li>
                  <li>
                    <a href="<?php echo $baseurl; ?>/quotations" >
                  ...
                  <li>
                    <a href="<?php echo $baseurl; ?>/receipts" >
              ...
              <li>
                ...
                <ul class="nav-sub">
                  <li>
                    <a href="<?php echo $baseurl; ?>/materials" >
              ...
              <li>
                <a href="<?php echo $baseurl; ?>/projects" class="b-warning">
                  <span class="nav-icon text-white no-fade">
              ...
              <li>
                <a href="<?php echo $baseurl; ?>/maintenances" class="b-info">
                  ...
                  <span class="nav-text">Maintenances</span>
                </a>
              </li>
              <li>
                <a href="<?php echo $baseurl; ?>/staff" class="b-warn">
                  <span class="nav-icon text-white no-fade">
  ...
  <div id="content" class="app-content box-shadow-z2 bg pjax-container" role="main">
    <div class="app-header white bg b-b">
          <div class="navbar" data-pjax>
                ...
                <div class="navbar-item pull-left h5" id="pageTitle"><?php echo $companyname;?></div>
                <!-- nabar right -->
...
<li class="list-group-item dark-white box-shadow-z0 b"><span class="pull-left m-r"><img src="<?php echo $baseurl; ?>/images/a8.jpg" alt="..." class="w-40 img-circle"></span> <span class="clear block">No notifications for now!<br><small class="text-muted">in Work Invoices</small></span></li>
<?php
}
else
{
...
$tdate=date("d/m/Y");
		...
		while($row = mysqli_fetch_assoc($result)) 
		{
			...
			$duedate=$row['duedate'];
?>	
<li class="list-group-item dark-white box-shadow-z0 b"><span class="pull-left m-r"><img src="<?php echo $baseurl; ?>/images/a11.jpg" alt="..." class="w-40 img-circle"></span> <span class="clear block"><?php echo $dueamt;?> AED Pending from 
<?php
...
?>
<li class="list-group-item dark-white box-shadow-z0 b"><span class="pull-left m-r"><img src="<?php echo $baseurl; ?>/images/a4.jpg" alt="..." class="w-40 img-circle"></span> <span class="clear block"><?php echo $x;?> Work Invoices are Pending!<br><small class="text-muted">Click here to view all</small></span></li>
<?php
}
?>
</ul></div></div></li>
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link clear" data-toggle="dropdown">
                      <span class="avatar w-32">
                        <img src="<?php echo $baseurl; ?>/images/user.png" class="w-full rounded" alt="...">
                      </span>
                    </a>
