...
$sql = "INSERT INTO `work_invoices` (`work`, `wtype`, `division`, `invoice`, `status`, `collector`, `duedate`, `issuedate`, `paid`, `due`, `method`, `notes`) 
VALUES ('$work', '$wtype', '$division', '$invoice', '$status', '$collector', '$duedate', '$issuedate', '$paid', '$due', '$method', '$notes')";
	...
	<?php }?>
      <div class="box">
        <div class="box-header">
          <h2>Add New Work Invoice</h2>
          </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/add/work_invoice" method="post">
...
<div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="text" class="form-control" name="invoice" id="invoice"  placeholder="Invoice No">
              </div>
            ...
            <div class="form-group row">
             <label for="amount" class="col-sm-2 form-control-label">Total Due</label>
              <div class="col-sm-4">
               <input type="number"  step="0.01" class="form-control" name="due" id="due" placeholder="Total Due Amount">
              </div>

              <label for="date" align="right" class="col-sm-2 form-control-label">Submit Date</label>
              <div class="col-sm-4">
                <input type="text"  name="issuedate" id="issuedate" placeholder="Issue Date" class="form-control has-value" data-ui-jp="datetimepicker" data-ui-options="{
            format: 'DD/MM/YYYY',
            icons: {
              time: 'fa fa-clock-o',
              date: 'fa fa-calendar',
          ...
          <div class="form-group row">
            ...
            <div class="form-group row">
             <label for="paid" class="col-sm-2 form-control-label">Paid Amount</label>
              <div class="col-sm-4">
               <input type="number" step="0.01" class="form-control" name="paid" id="paid" placeholder="Paid Amount">
              </div>

              <label for="date" align="right" class="col-sm-2 form-control-label">Payment Date</label>
              <div class="col-sm-4">
                <input type="text" name="duedate" id="duedate" placeholder="Payment Date" class="form-control has-value" data-ui-jp="datetimepicker" data-ui-options="{
            format: 'DD/MM/YYYY',
            icons: {
              time: 'fa fa-clock-o',
              date: 'fa fa-calendar',
