			        ...
			        <li class="nav-item">
				        <a href="<?php echo $baseurl; ?>/add/customer" class="nav-link text-muted" title="Reply">
				            <span class="">
                                ...
                                <li class="nav-item">
				        <a target="_blank" href="<?php echo $cdn_url;?>/reports/contacts" class="nav-link text-muted" title="Reply">
				            <span class="">
...
function cname(value){
  $.post("api/contact.php", {cname:value}, function(data){
    $("#contactlist").html(data);
  });
}
</script>
...
<?php
$sql2 = "SELECT tag from customer_tags";
...
?>
	...
	<li>
	  <a href="javascript:void(0);" onclick="contact_tag('<?php echo $row2['tag'];?>')">
					<span class="nav-label">
									                    	<b class="label label-xs primary">&nbsp;</b>
									                  	</span>
					<span class="nav-text"><?php echo $row2['tag'];?></span>
	  </a>
										  	</li>
...
<a href="javascript:void(0);" onclick="contact_type('<?php echo $type; ?>')" class="btn btn-outline btn-sm rounded b-info text-info"><?php echo $type; ?></a>								
 		        ...
 		        <ul class="nav">
 		            ...
 		            <li class="nav-item m-b-xs">
 		              	...
 		              	<a class="nav-link text-muted block">
 		                	<span class="pull-right text-sm">
 		                		<b>Makani No <i class="fa fa-address-card"></i></b>
 		                	</span>
 		                	<span><?php echo $makani."&nbsp;"; ?></span>
 		              	</a>
 		            </li></b>
 		        </ul>
							        </div>
...
<div class="p-a-lg text-center">
					        <a href="#">
																																																		<span class="w-40 avatar circle animated rollIn danger"><h3>!</h3></span></a>
	<div class="animated fadeInUp">
		<div>
