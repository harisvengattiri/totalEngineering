...
<div class="padding">
    ...
    <div class="col-md-6">
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/report/chart_of_accounts" method="post" onsubmit="target_popup(this)">
            ...
            <div class="form-group row">
              <label class="col-sm-5 form-control-label">Consider Opening Balance</label>
              <input style="margin-top:13px;" type="checkbox" name="consider_opening" value="1">
            </div>
