...
<div class="padding">
  <div class="box">
	...
	<span style="float: left;"><h2>Cash Voucher</h2></span> 
...
{ 
?>
<a href="<?php echo $baseurl; ?>/voucher_cash" ><button class="btn btn-outline btn-sm rounded b-success text-success"><i class="fa fa-list"></i> View Recent</a></button>
<?php 
}
else 
{ 
?>
<a href="<?php echo $baseurl; ?>/voucher_cash?view=all" ><button class="btn btn-outline btn-sm rounded b-success text-success"><i class="fa fa-list"></i> View All</a></button>
<?php 
} ?>
</span>
    </div><br/>
...
//         }
		if (isset($_GET['view']))
		{
		$sql = "SELECT * FROM voucher WHERE pmethod='cash' ORDER BY id DESC";
                }
                else
		{
		$sql = "SELECT * FROM voucher WHERE pmethod='cash' ORDER BY id DESC LIMIT 0,100";
                }
