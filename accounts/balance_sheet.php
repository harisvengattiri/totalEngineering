...
<h2 style="text-align:center;margin-bottom:1px;"><?php // echo strtoupper($status);?>BALANCE SHEET</h2>
...
<!--SUB SECTION ENDS HERE -->
        ...
        <tr>
            <?php $net_income = array_sum($tot_debit) - array_sum($tot_credit);?>
            <td colspan="2"></td>
            <td colspan="1" style="text-align:center;"><b>Net Income</b></td>
            <td></td>
            <td style="text-align:right;"><b><?php echo custom_money_format('%!i', $net_income);?></b></td>
            <?php $tot_credit[] = $net_income;?>
        </tr>
      ...
      <br><br>
      <a href="balance_sheet_opening?fdate=<?php echo $fdate;?>&tdate=<?php echo $tdate;?>">
          <button type="button" class="btn btn-success" style="margin-left:45%;">Save and continue to next year</button>
      </a>
      <br><br><br><br>
<?php
