...
<!--Receivables starts here-->
    <div id="sitepo" class="row">
    <div class="col-md-6">
      <div class="box">
        <div class="box-header">
             <h2>Receivable Report [ Based on Period ]
                  <!--<span style="color:red;">[From & To Dates are mandatory]</span>-->
             </h2>
          </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/accounts/rep_receivable" method="post" onsubmit="target_popup(this)">
...
<!--PDC starts here-->
  <div id="sitepo" class="row">
    <div class="col-md-6">
      <div class="box">
        <div class="box-header">
             <h2>PDC Report [ Based on Period ]
                  <!--<span style="color:red;">[From & To Dates are mandatory]</span>-->
             </h2>
          </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" action="<?php echo $baseurl;?>/accounts/rep_pdcOnPeriod" method="post" onsubmit="target_popup(this)">
