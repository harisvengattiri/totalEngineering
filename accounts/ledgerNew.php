                ...
                while($result_cat = mysqli_fetch_array($query_cat)) {
                    ...
                    $entry_type = $result_cat['entry'];
                        ...
                        if($entry_type == 'Dr') {
                            ...
                            $curr_cat_amt = $cat_amt;
                                $tot_curr_debit[] = $curr_cat_amt;
                            $cat_amt = $cat_amt+$opnCat;
                            $tot_debit[] = $cat_amt;
                        } else if($entry_type == 'Cr') {
                            $cat_amt = ($cat_amt != NULL) ? $cat_amt : 0;
                            $curr_cat_amt = $cat_amt;
                                $tot_curr_credit[] = $curr_cat_amt;
                            $cat_amt = $cat_amt+$opnCat;
                            $tot_credit[] = $cat_amt;
                        }
            ?>
                ...
                <tr>
                  ...
                  <?php if($entry_type == 'Dr') { ?>
                      <td style="font-size:18px;text-align:right;"><?php echo custom_money_format('%!i', $curr_cat_amt);?></td>
                      <td></td>
                  <?php } else if($entry_type == 'Cr') { ?>
                      <td></td>
                      <td style="font-size:18px;text-align:right;"><?php echo custom_money_format('%!i', $curr_cat_amt);?></td>
...
<!--SUB SECTION STARTS HERE -->                
                ...
                ?>
                    ...
                    <?php if($entry_type == 'Dr') { ?>
                        <td style="text-align:right;"><b><?php echo custom_money_format('%!i', $curr_sub_amt);?></b></td>
                        <td></td>
                      <?php } else if($entry_type == 'Cr') { ?>
                        <td></td>
                        <td style="text-align:right;"><b><?php echo custom_money_format('%!i', $curr_sub_amt);?></b></td>
...
<!--SUB SECTION ENDS HERE -->
        ...
        <tr>
            ...
            <td style="text-align:right;"><b><?php echo custom_money_format('%!i', array_sum($tot_curr_debit));?></b></td>
            <td style="text-align:right;"><b><?php echo custom_money_format('%!i', array_sum($tot_curr_credit));?></b></td>
